...
{
	public class ReportDateService : IDateService, INotifyPropertyChanged
	{
		private DateTime? _dateForReport = DateTime.Now;

		public DateTime DateForReport
		{
			get { return _dateForReport.Value; }
			set 
			{
				_dateForReport = value;
				OnPropertyChanged("DateForReport");
			}
		}
		...
		{
			DateForReport = DateForReport.AddMonths(1);
